...
test('eight-week journey is learner-facing, sequential, and does not confuse self-reported study with mastery', async () => {
  const [html, css, source, dataFile, legacyPath, landing] = await Promise.all([
    'integrated-path.html', 'integrated-path.css', 'integrated-path.js', 'data/eight-week-integrated-path.json', 'path.html', 'seder.html'
  ...
  assert.match(legacyPath, /url=integrated-path\.html/);
  assert.match(landing, /href="integrated-path\.html"/);
