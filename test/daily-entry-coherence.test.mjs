...
test('learner-facing Today links use the single evidence-led daily router', async () => {
  const [profile, path, daily, today, berakhot, shell] = await Promise.all(
    ['profile.html', 'path.js', 'daily.html', 'today.html', 'berakhot-deep.html', 'jla-shell.js']
  ...
  // berakhot-deep still carries the static Today link.
