(() => {
  ...
  style.textContent = `
    ...
    #tractate-daf-rail h2{margin:7px 0;color:#183b4e;font:600 25px Fraunces,Georgia,serif}.tractate-daf-intro{margin:0 0 14px;color:#5d6a71;font-size:12px;line-height:1.5}
